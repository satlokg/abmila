...
<body>
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        <form action="#" class="search_form">
                            <div class="atbd_seach_fields_wrapper">
                                ...
                                <div class="atbd_submit_btn btnnsc">
    ...
    <div  class="fullwithh">
        <div class="fullmmn">
<div class="container">
                <h2 class="catthhs">Popular Categories</h2>
                            
            <div class="row  maincatgg">
    <div class="col-sm-4 col-md-4">
        <div class="row">
            <div class="col-sm-12 col-md-6" >
            <a href="#" class="logss"><img src="{{asset('public/img/icon1.png')}}" alt=""></a>
<figcaption class="cptoon">Home& Office</figcaption>
            ...
            <a href="#" class="logss"><img src="{{asset('public/img/icon2.png')}}" alt=""></a>
             <figcaption class="cptoon">Home Improvement<figcaption>
            </div>
        </div>
    </div>
    <div class="col-sm-4 col-md-4">
        <div class="row">
            ...
            <a href="#" class="logss"><img src="{{asset('public/img/icon3.png')}}" alt=""></a>
             <figcaption class="cptoon">Properties & Rentasl</figcaption>
            
            </div>
            <div class="col-sm-12 col-md-6" >
                        
            <a href="#" class="logss"><img src="{{asset('public/img/icon4.png')}}" alt=""></a>
             <figcaption class="cptoon">Education & Training</figcaption>
    ...
    <div class="col-sm-4 col-md-4">
        <div class="row">
            ...
            <a href="#" class="logss"><img src="{{asset('public/img/icon5.png')}}" alt=""></a>
             <figcaption class="cptoon">Professional Services
</figcaption>
            </div>
            <div class="col-sm-12 col-md-6" >
<a href="#" class="logss"><img src="{{asset('public/img/icon6.png')}}" alt=""></a>
             <figcaption class="cptoon">Travel & Transport</figcaption>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-bottom--content">
                            <a href="#" class="footer-logo"><img src="img/footerlogo.png" alt=""></a>
                            <p class="m-0 copy-text">©2019 Abmila </p>
